 ...
 *@class MainTriangleViewer.cs
 *@class   └ new FormTriangleViewer() : Form
 ...
 *           
 *@content Equilateral TriangleViewer
 *         正三角形を描画するアルゴリズム
 *         [英] equilateral triangle:  正三角形
 *         [英] regular triangle:      正三角形
 *         [英] algorithm              アルゴリズム
...
{
    class MainTriangleViewer
    {
        //[STAThread]
        //static void Main()
        public void Main()
        {
            Console.WriteLine("new FormTriangleViewer()");

            Application.EnableVisualStyles();
            Application.Run(new FormTriangleViewer());

            Console.WriteLine("Close()");
        }//Main()
    }//class

    class FormTriangleViewer : Form
    {
        ...
        public FormTriangleViewer()
        {
            this.Text = "FormTriangleViewer";
