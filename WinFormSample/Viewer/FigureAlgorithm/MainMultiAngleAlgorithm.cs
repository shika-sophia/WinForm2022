 ...
 *@class MainMultiAngleAlgorithm .cs
 *@class   └ new FormMultiAngleAlgorithm () : Form
 ...
 *        :
 *
 *@see ImageMultiAngleAlgorithm.jpg
 *@see 
 *@author shika
 *@date 2022-09-12
 */
...
namespace WinFormGUI.WinFormSample.Viewer.FigureAlgorithm
{
    class MainMultiAngleAlgorithm
    {
        ...
        //public void Main()
        {
            ...
            Application.Run(new FormMultiAngleAlgorithm());

            Console.WriteLine("Close()");
        }//Main()
    }//class

    class FormMultiAngleAlgorithm : Form
    {
        ...
        public FormMultiAngleAlgorithm()
        {
            this.Text = "FormMultiAngleAlgorithm";
